...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h2 mb-0 page-title">
            ...
            History Komentar Dihapus
        </h1>
        <p class="page-subtitle mb-0">Daftar komentar tugas yang telah dihapus</p>
    </div>
    <div class="btn-group">
        <a href="index.php?url=tasks" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left me-2"></i>Kembali ke Tugas
        </a>
        <a href="index.php?url=bugs/deleted-comments" class="btn btn-outline-primary">
            <i class="fas fa-bug me-2"></i>Komentar Bug Dihapus
        </a>
    </div>
</div>
...
<?php if (empty($deletedComments)): ?>
    <div class="text-center py-5">
        ...
        <p class="page-subtitle">Belum ada komentar tugas yang dihapus.</p>
    </div>
<?php else: ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-light">
                    <h5 class="card-title mb-0">
                        ...
                        Daftar Komentar Dihapus (<?php echo count($deletedComments); ?>)
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="deleted-comment-card p-3">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <div class="text-end">
                                ...
                                <div class="btn-group btn-group-sm">
                                    <a href="index.php?url=tasks/view/<?php echo $comment['task_id']; ?>" class="btn btn-outline-primary">
                                        <i class="fas fa-eye me-1"></i>Lihat Tugas
                                    </a>
                                    <button type="button" class="btn restore-btn text-white" onclick="restoreComment(<?php echo $comment['task_id']; ?>, <?php echo $comment['id']; ?>)">
                        ...
                        <div class="comment-content">
                            <div class="mb-2">
                                <strong>Tugas:</strong> 
                                <a href="index.php?url=tasks/view/<?php echo $comment['task_id']; ?>" class="text-decoration-none">
                                    <?php echo htmlspecialchars($comment['task_title']); ?>
                                </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body p-3 p-md-4">
        <div class="text-center mb-3">
          ...
          <p class="text-muted mb-3">Komentar akan dikembalikan ke tugas asalnya.</p>
          <div class="alert alert-info">
            <i class="fas fa-info-circle me-2"></i>
            Komentar yang dikembalikan akan tersedia kembali di tugas terkait.
          </div>
        </div>
      </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (confirmRestoreBtn) {
        confirmRestoreBtn.addEventListener('click', function() {
            if (restoreTaskId === null || restoreCommentId === null) return;
            
            // Create a form to submit the restore request
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = 'index.php?url=tasks/restore-comment/' + restoreTaskId + '/' + restoreCommentId;
